...
export function ScreenshotWithPins({ screenshotUrl, viewport, elementCoordinates = {}, findings = [], onPinClick }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative w-full" style={{ backgroundColor: 'var(--bg)' }}>
      <img
        ref={imageRef}
        src={screenshotUrl}
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: matchingFinding ? '#FB3B24' : 'var(--neg)',
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: hoveredPin === selector 
                        ? (matchingFinding ? '#FB3B24' : 'var(--neg)')
                        : (matchingFinding ? '#FB3B24' : 'var(--neg)'),
                      borderColor: 'var(--bg)',

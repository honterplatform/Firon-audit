            ...
            >
              <div className="p-4 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-2 mb-3 flex-wrap" onClick={(e) => e.stopPropagation()}>
                  <Badge className={`${getImpactColor(finding.impact)} text-[8px] uppercase font-light tracking-[0.2em] px-2 py-0.5 rounded-full`} style={{ color: '#0a211f', backgroundColor: 'rgba(255, 149, 149, 0.3)' }}>
                    {finding.impact} Impact
                  </Badge>
                  <Badge className={`${getEffortColor(finding.effort)} text-[8px] uppercase font-light tracking-[0.2em] px-2 py-0.5 rounded-full`} style={{ color: '#0a211f', backgroundColor: 'rgba(161, 212, 255, 0.3)' }}>
                ...
                <div className="mb-3 h-14">
                  <h3 className="text-lg font-normal leading-tight line-clamp-2" style={{ color: '#0a211f' }}>
                    {finding.issue}
                  </h3>
                </div>
                ...
                <div className="mb-4 flex-1">
                  <div>
                    <p className="text-[10px] font-light uppercase tracking-wide mb-1" style={{ color: '#0a211f' }}>
                      Why this matters
                    </p>
                    <p className="text-sm leading-relaxed line-clamp-3" style={{ color: '#0a211f' }}>
                      {finding.why}
                    </p>
                  </div>
                </div>
                ...
                {/* Footer with button */}
                <div 
                  className="pt-3 border-t border-gray-200 flex items-center justify-start"
